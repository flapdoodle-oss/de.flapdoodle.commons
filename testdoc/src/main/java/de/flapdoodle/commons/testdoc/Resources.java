 ...
 */
package de.flapdoodle.commons.testdoc;
...
abstract class Resources {
	...
	private static List<Path> sourceCodeRoots() {
		try {
			Path testClassResourcePath = Paths.get(Objects.requireNonNull(Resources.class.getResource("/")).toURI());
			Path mayBeMavenRoot = testClassResourcePath.getParent().getParent().toAbsolutePath();
