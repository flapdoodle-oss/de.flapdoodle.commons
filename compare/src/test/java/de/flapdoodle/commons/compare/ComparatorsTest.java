 ...
 */
package de.flapdoodle.commons.compare;
...
public class ComparatorsTest {
	...
	public void simpleSample() {
		Comparator<Object> comparator = Comparators.matching(TypeInfo.of(String.class)::ifInstance, String::compareTo)
			.thenComparing(Comparators.matching(TypeInfo.of(Integer.class)::ifInstance, Integer::compareTo))
			.thenComparing(Comparators.matching(TypeInfo.of(Long.class)::ifInstance, Long::compareTo));
