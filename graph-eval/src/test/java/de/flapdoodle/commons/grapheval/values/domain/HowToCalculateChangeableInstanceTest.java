...
import de.flapdoodle.commons.grapheval.AbstractHowToTest;
import de.flapdoodle.commons.grapheval.GraphvizAdapter;
import de.flapdoodle.commons.grapheval.Value;
import de.flapdoodle.commons.grapheval.calculate.ValueLookup;
import de.flapdoodle.commons.grapheval.explain.RuleDependencyGraph;
...
public class HowToCalculateChangeableInstanceTest extends AbstractHowToTest {
	...
	void sumOfItemsInCart() {
		...
		recording.file("render.dot.svg", "HowToCalculateChangeableInstanceTest.svg", GraphvizAdapter.asSvg(dot));

		recording.begin("explain");
		String explainDot = RuleDependencyGraph.explain(rules);
		recording.end();
		recording.output("explain.dot", explainDot);
		recording.file("explain.dot.svg", "HowToCalculateChangeableInstanceTest-explained.svg", GraphvizAdapter.asSvg(explainDot));
