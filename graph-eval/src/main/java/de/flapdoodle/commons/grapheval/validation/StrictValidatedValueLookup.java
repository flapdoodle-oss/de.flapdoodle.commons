 ...
 */
package de.flapdoodle.commons.grapheval.validation;

import com.google.common.base.Preconditions;
import de.flapdoodle.commons.grapheval.ValueSource;
import de.flapdoodle.commons.grapheval.types.Checks;
...
public abstract class StrictValidatedValueLookup implements ValidatedValueLookup {
	...
	protected void check() {
		Set<de.flapdoodle.commons.grapheval.Value<?>> collidingIds = Checks.collisions(validatedValues(), ValidatedValue::source);
