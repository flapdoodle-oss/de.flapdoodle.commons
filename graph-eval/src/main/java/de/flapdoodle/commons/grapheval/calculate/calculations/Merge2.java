...
import de.flapdoodle.commons.grapheval.calculate.functions.FN2;
...
public abstract class Merge2<A, B, X> implements Calculation<X>, HasHumanReadableLabel {
	@Value.Parameter
	...
	@Value.Parameter
	protected abstract FN2<A, B, X> transformation();
