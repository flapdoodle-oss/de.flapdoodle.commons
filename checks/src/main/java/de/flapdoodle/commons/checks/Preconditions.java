...
public abstract class Preconditions {
	...
	public static boolean checkArgument(boolean expression, String errorMessage, Object... args) {
		if (!expression) {
	...
	public static boolean checkState(boolean expression,	String errorMessage, Object... args) {
		if (!expression) {
