...
digraph "wrapped" {
  ...
  subgraph cluster_1 {
    label = "hidden";
    "de.flapdoodle.commons.reverse.ImmutableMappedWrapper:0__<empty>:ClassTypeInfo{type=class java.lang.String}"[ shape="ellipse", label="<empty>:String" ];
    "de.flapdoodle.commons.reverse.ImmutableMappedWrapper:0__de.flapdoodle.commons.reverse.transitions.ImmutableStart:0"[ shape="rectangle", label="Start" ];

    "de.flapdoodle.commons.reverse.ImmutableMappedWrapper:0__de.flapdoodle.commons.reverse.transitions.ImmutableStart:0" -> "de.flapdoodle.commons.reverse.ImmutableMappedWrapper:0__<empty>:ClassTypeInfo{type=class java.lang.String}";
  }

  "<empty>:ClassTypeInfo{type=class java.lang.String}" -> "de.flapdoodle.commons.reverse.transitions.ImmutableDerive:0";
  "de.flapdoodle.commons.reverse.transitions.ImmutableDerive:0" -> "depends:ClassTypeInfo{type=class java.lang.String}";
  "de.flapdoodle.commons.reverse.ImmutableMappedWrapper:0__<empty>:ClassTypeInfo{type=class java.lang.String}" -> "<empty>:ClassTypeInfo{type=class java.lang.String}";
}
